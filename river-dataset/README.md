...
**Data Access:** The dataset is not included in this repository, as the raw `.mat` cubes exceed GitHub's 100 MB file limit. Download the dataset from the GETNET(https://drive.google.com/file/d/1cWy6KqE0rymSk5-ytqr7wM1yLMKLukfP/view) benchmark source and place `river_before.mat`, `river_after.mat`, and `groundtruth.mat` in a `data/` folder before running the script in this repo.
